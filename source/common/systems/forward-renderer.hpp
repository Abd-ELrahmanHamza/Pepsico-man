...
namespace our
{
    ...
    class ForwardRenderer
    {
        ...
        // These vectors for lighting
        std::vector<LightComponent *> lights_list;   // store all point and directinal lights
        std::vector<LightComponent *> street_lights; // store all spot lights
