...
namespace our
{
    ...
    inline void deserializeComponent(const nlohmann::json &data, Entity *entity)
    {
        ...
        {                                                              // check if the type is a mesh renderer component
